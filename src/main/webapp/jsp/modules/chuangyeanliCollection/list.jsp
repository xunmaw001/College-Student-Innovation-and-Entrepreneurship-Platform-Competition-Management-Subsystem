...
<script>
    ...
    function getDataList() {
        http("chuangyeanliCollection/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("chuangyeanliCollection/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addchuangyeanliCollection", "addchuangyeanliCollection");
        window.location.href = "add-or-update.jsp"
    }
