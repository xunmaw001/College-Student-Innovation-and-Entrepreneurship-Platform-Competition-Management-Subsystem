    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">创业项目管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">创业项目列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">创业项目列表</h3>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(chuangyexiangmuNameCell);
            ...
            //样本图片
        var chuangyexiangmuPhotoCell = document.createElement('td');
        var chuangyexiangmuPhotoImg = document.createElement('img');
        var chuangyexiangmuPhotoImgValue = item.chuangyexiangmuPhoto;
        if(chuangyexiangmuPhotoImgValue !=null && chuangyexiangmuPhotoImgValue !='' && chuangyexiangmuPhotoImgValue !='null'){
            chuangyexiangmuPhotoImg.setAttribute('src', chuangyexiangmuPhotoImgValue);
            chuangyexiangmuPhotoImg.setAttribute('height', 100);
            chuangyexiangmuPhotoImg.setAttribute('width', 100);
            chuangyexiangmuPhotoCell.appendChild(chuangyexiangmuPhotoImg);
        }else{
            chuangyexiangmuPhotoCell.innerHTML = "暂无图片";
        }
        row.appendChild(chuangyexiangmuPhotoCell);
        ...
        row.appendChild(leixTypesCell);
            ...
            //项目具体内容
        var chuangyexiangmuContentCell = document.createElement('td');
        //如果图文详情包含图片
        if (item.chuangyexiangmuContent && item.chuangyexiangmuContent.indexOf('img') != -1) {
            //暂时只考虑图片+文字 和 文字+图片的情况
            var beginIndex = item.chuangyexiangmuContent.indexOf('<img');
            var endIndex = item.chuangyexiangmuContent.indexOf('>');
                chuangyexiangmuContentCell.innerHTML = item.chuangyexiangmuContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
        } else {
            if (item.chuangyexiangmuContent != null && item.chuangyexiangmuContent != "" && item.chuangyexiangmuContent.length >= 11) {
                    chuangyexiangmuContentCell.innerHTML = item.chuangyexiangmuContent.substring(0, 10) + "...";
            } else {
                    chuangyexiangmuContentCell.innerHTML = item.chuangyexiangmuContent;
            }
        }
        row.appendChild(chuangyexiangmuContentCell);
        ...
        //报名
        var detailBtn = document.createElement('button');
        var detailAttr = "baoming(" + item.id + ')';
        detailBtn.setAttribute("type", "button");
        detailBtn.setAttribute("class", "btn btn-info btn-sm 报名");
        detailBtn.setAttribute("onclick", detailAttr);
        detailBtn.innerHTML = "报名"
        btnGroup.appendChild(detailBtn)
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("chuangyexiangmu/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    function baoming(id) {
        ...
        if (mymessage == true) {
            http("chuangyexiangmu/baoming?ids="+id, "get", {}, (res) => {
                if(res.code == 0){
                getDataList();
                alert('报名成功');
            }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addchuangyexiangmu", "addchuangyexiangmu");
        window.location.href = "add-or-update.jsp"
    }
