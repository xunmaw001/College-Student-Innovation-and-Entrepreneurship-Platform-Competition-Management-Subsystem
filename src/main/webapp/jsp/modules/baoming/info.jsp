            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">报名登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="bianhao" name="bianhao" class="form-control"
                                               v-model="ruleForm.bianhao" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="baomingPhone" name="baomingPhone" class="form-control"
                                               v-model="ruleForm.baomingPhone" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>审核结果</label>
                                    <input id="baomingValue" name="baomingValue" class="form-control"
                                           v-model="ruleForm.baomingValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="baomingPingfen" name="baomingPingfen" class="form-control"
                                               v-model="ruleForm.baomingPingfen" readonly>
                                    </div>
