...
var projectName = '大学生创新创业平台竞赛管理子系统';
/**
 * 轮播图配置
 */
var swiper = {
...
var centerMenu = [
    ...
    ,{
        name: '案例收藏',
        url: '../chuangyeanliCollection/list.jsp'
    }
    ,{
        name: '项目收藏',
        url: '../chuangyexiangmuCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '创业案例',
        url: './pages/chuangyeanli/list.jsp'
    },
    {
        name: '创业项目',
        url: './pages/chuangyexiangmu/list.jsp'
    },
    {
        name: '创业动态',
...
var adminurl =  "http://localhost:8080/chuangyejingsai/index.jsp";
