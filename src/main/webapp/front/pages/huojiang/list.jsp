            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">获奖项目展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huojiangName" id="huojiangName" placeholder="获奖项目" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="canyurenyuan" id="canyurenyuan" placeholder="参与人员" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#huojiangName').val() != null && jquery('#huojiangName').val() != "" && jquery('#huojiangName').val() != "null" ) {
                param['huojiangName'] = jquery('#huojiangName').val();
            }
     
            if (jquery('#canyurenyuan').val() != null && jquery('#canyurenyuan').val() != "" && jquery('#canyurenyuan').val() != "null" ) {
                param['canyurenyuan'] = jquery('#canyurenyuan').val();
            }
                        // 获取列表数据
            http.request('huojiang/list', 'get', param, function(res) {
