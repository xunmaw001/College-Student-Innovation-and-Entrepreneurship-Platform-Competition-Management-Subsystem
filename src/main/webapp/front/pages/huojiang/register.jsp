              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">获奖项目:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="huojiangName" id="huojiangName"  placeholder="获奖项目"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">参与人员:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="canyurenyuan" id="canyurenyuan"  placeholder="参与人员"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
