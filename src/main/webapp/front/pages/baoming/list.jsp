            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">报名展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="bianhao" id="bianhao" placeholder="竞赛编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#bianhao').val() != null && jquery('#bianhao').val() != "" && jquery('#bianhao').val() != "null" ) {
                param['bianhao'] = jquery('#bianhao').val();
            }
                                            // 获取列表数据
            http.request('baoming/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function baomingTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=baoming_types", 'get', {}, function (res) {
               if(res.code == 0){
