                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../chuangyexiangmu/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../chuangyexiangmu/detail.jsp?id='+item.id)"><span>{{item.chuangyexiangmuName}}</span></div>
        ...
        function pageList() {
            ...
            if (leixTypes != null && leixTypes != "" && leixTypes != "null") {
                param['leixTypes'] = leixTypes;
                    ...
                    // 获取列表数据
            http.request('chuangyexiangmu/list', 'get', param, function(res) {
