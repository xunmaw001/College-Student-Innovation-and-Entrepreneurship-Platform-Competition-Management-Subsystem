            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">项目收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="chuangyexiangmuName" id="chuangyexiangmuName" placeholder="项目标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                                                             
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">项目分类名称</label>
                          <div class="layui-input-inline">
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../chuangyexiangmu/detail.jsp?id='+item.chuangyexiangmuId)">
                                        <a href="#" class="ng-prsliik">
                                          <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.chuangyexiangmuPhoto?item.chuangyexiangmuPhoto.split(',')[0]:''" />
                                          </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../chuangyexiangmu/detail.jsp?id='+item.chuangyexiangmuId)"><span>{{item.chuangyexiangmuName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.chuangyexiangmuNewMoney"><span style="color: red;">{{item.chuangyexiangmuNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#chuangyexiangmuName').val() != null && jquery('#chuangyexiangmuName').val() != "" && jquery('#chuangyexiangmuName').val() != "null" ) {
                param['chuangyexiangmuName'] = jquery('#chuangyexiangmuName').val();
            }
            ...
            // 当前表
                                // 获取列表数据
            http.request('chuangyexiangmuCollection/list', 'get', param, function(res) {
