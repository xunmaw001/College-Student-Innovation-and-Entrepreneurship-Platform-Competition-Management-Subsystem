    ...
    <div class="data-detail">
        <div class="data-detail-breadcrumb">
					<span class="layui-breadcrumb">
						...
						<a><cite>{{detail.chuangyexiangmuCollectionName}}</cite></a>
					</span>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            // 当前详情页表
            detailTable: 'chuangyexiangmuCollection',
        },
        //  清除定时器
        destroyed: function () {
            // 不知道具体作用
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function (res) {
            ...
            vue.detail = res.data;
           // 轮播图片
            vue.swiperList = vue.detail.chuangyexiangmuCollectionPhoto ? vue.detail.chuangyexiangmuCollectionPhoto.split(",") : [];
            var swiperItemHtml = '';
