                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiaoshiName" id="jiaoshiName" placeholder="姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiaoshiIdNumber" id="jiaoshiIdNumber" placeholder="身份证号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiaoshiPhone" id="jiaoshiPhone" placeholder="手机号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#jiaoshiIdNumber').val() != null && jquery('#jiaoshiIdNumber').val() != "" && jquery('#jiaoshiIdNumber').val() != "null" ) {
                param['jiaoshiIdNumber'] = jquery('#jiaoshiIdNumber').val();
            }
     
            if (jquery('#jiaoshiPhone').val() != null && jquery('#jiaoshiPhone').val() != "" && jquery('#jiaoshiPhone').val() != "null" ) {
                param['jiaoshiPhone'] = jquery('#jiaoshiPhone').val();
            }
                    // 获取列表数据
