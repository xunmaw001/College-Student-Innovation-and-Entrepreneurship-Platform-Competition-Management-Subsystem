                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="chuangyeanliName" id="chuangyeanliName" placeholder="案例名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../chuangyeanli/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.chuangyeanliPhoto?item.chuangyeanliPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../chuangyeanli/detail.jsp?id='+item.id)"><span>{{item.chuangyeanliName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.chuangyeanliNewMoney"><span style="color: red;">{{item.chuangyeanliNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#chuangyeanliName').val() != null && jquery('#chuangyeanliName').val() != "" && jquery('#chuangyeanliName').val() != "null" ) {
                param['chuangyeanliName'] = jquery('#chuangyeanliName').val();
            }
            ...
            if (leixTypes != null && leixTypes != "" && leixTypes != "null") {
                param['leixTypes'] = leixTypes;
                            ...
                            // 获取列表数据
            http.request('chuangyeanli/list', 'get', param, function(res) {
