 ...
 * @date 2021-04-03
 */
@TableName("chuangyexiangmu_collection")
public class ChuangyexiangmuCollectionView extends ChuangyexiangmuCollectionEntity implements Serializable {
	...
	public ChuangyexiangmuCollectionView() {

	}

	public ChuangyexiangmuCollectionView(ChuangyexiangmuCollectionEntity chuangyexiangmuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, chuangyexiangmuCollectionEntity);
