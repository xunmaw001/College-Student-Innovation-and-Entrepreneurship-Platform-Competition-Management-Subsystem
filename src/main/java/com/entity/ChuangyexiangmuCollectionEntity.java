...
public class ChuangyexiangmuCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChuangyexiangmuCollectionEntity() {

	}

	public ChuangyexiangmuCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "ChuangyexiangmuCollection{" +
            "id=" + id +
